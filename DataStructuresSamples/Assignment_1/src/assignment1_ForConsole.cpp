...
//	Description	: Data Structures Assignment 1
//
//	Important Notes:
//
//============================================================================//
...
//============================ GLOBAL VARIABLES ==============================//
//============================================================================//
static char gridFileName[FILE_NAME_LENGTH]		= {0};
static char instructionsFileName[FILE_NAME_LENGTH]	= {0};
...
static int doInstructions(void)
{
	...
	if (fd != NULL)
	{
		// get memory for instruction process buffer
		instruction.process = (char *)malloc(4 * sizeof(char));

		// read instruction file and do instructions
		while (true)
		{			
			memset(instruction.process, 0, 4);
